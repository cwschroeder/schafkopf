    ...
    quiz: [
      {
        ...
        options: ['32 Karten', '52 Karten', '36 Karten', '24 Karten'],
      ...
      },
      {
        ...
        options: ['Eichel', 'Herz', 'Gras', 'Schellen'],
...
3. **Restliche Herz-Karten** (Sau, 10, König, 9 = 4 Stück)

Das sind zusammen **12 Trümpfe** (Herz-Ober und Herz-Unter sind schon bei den Obern/Untern dabei).`,
      },
      {
        type: 'trump-order',
        spielart: 'sauspiel',
    ...
    quiz: [
      {
        ...
        options: ['14', '10', '12', '8'],
        correctAnswer: '12',
        explanation: '4 Ober + 4 Unter + 4 restliche Herz = 12 Trümpfe (Herz-Ober und -Unter sind schon bei den Obern/Untern gezählt).',
      },
      {
        id: 'q2',
        type: 'multiple-choice',
        question: 'Welcher ist der höchste Trumpf?',
        options: ['Herz-Sau', 'Gras-Ober', 'Eichel-Unter', 'Eichel-Ober'],
...
Höhere Spiele (Wenz, Solo) übertreffen niedrigere (Sauspiel).`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['Pass', 'Nein', 'Schluss', 'Weiter'],
